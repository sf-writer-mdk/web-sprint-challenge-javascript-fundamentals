...
// a function has access to its' parents' variable environment. 'internal' is not in 'nestedFunction' so it follows the scope chain and looks to it's immediate ancestor
...
function lowerCaseNames(array) {
  const lowCaseAnimalNames = array.map(function (item) {
...
function lowPopulationAnimals(array) {
  const lowPopAn = array.filter(function (item) {
...
function USApop(array) {
  const USpop = array.reduce(function (accum, item) {
